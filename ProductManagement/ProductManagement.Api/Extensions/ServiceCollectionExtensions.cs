...
using ProductManagement.Application.DTOs.Settings;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\ProductManagement.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
