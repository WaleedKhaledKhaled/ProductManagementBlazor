...
using ProductManagement.Web.Extensions;
    ...
    public class ProductController : BaseController<ProductController>
    {
        ...
        public async Task<JsonResult> OnGetCreateOrEdit(int id = 0)
        {
            ...
            if (id == 0)
            {
                ...
                {
                    var CategoryViewModel = _mapper.Map<List<CategoryViewModel>>(CategoriesResponse.Data);
                    productViewModel.Categories = new SelectList(CategoryViewModel, "Id", "Name", null, null);
                }
